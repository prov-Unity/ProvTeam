...
public class PlayerInputManager : MonoBehaviour
{
    ...
    private void Update() {
        ...
        if(Input.GetKeyDown(KeyCode.Alpha1) && player.playerInfo.curWeapon != WeaponType.Fist_Left) {
            // switch to fist
            ...
            player.playerInfo.curWeapon = WeaponType.Fist_Left;
            player.playerInfo.attackIndex = 0;
            player.playerAnimation.ChangeMoveToFist();
        }
        if(Input.GetKeyDown(KeyCode.Alpha2) && player.playerInfo.curWeapon != WeaponType.Bone_Right) {
            // switch to bone
            ...
            player.playerInfo.curWeapon = WeaponType.Bone_Right;
            player.playerInfo.attackIndex = 0;
